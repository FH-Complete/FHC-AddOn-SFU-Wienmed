                                ...
                                <fo:table-row line-height="19pt">
                                    ...
                                    <fo:table-cell border-width="0.2mm" border-style="solid"  display-align="center" >
                                        <fo:block font-size="9pt" content-width="60mm" vertical-align="center" font-family="arial">
                                            <xsl:text> </xsl:text>
                                            <xsl:value-of select="abschlusspruefung_note_english" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                ...
                <fo:block font-size="9pt" content-width="102mm" vertical-align="center" font-family="arial">
                    ...
                    <xsl:choose>
                        <xsl:when test="bisio_von">
                            <xsl:text>International Semester Abroad: </xsl:text>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>[ACHTUNG: Keine englische Bezeichung für "</xsl:text>
                                    <xsl:value-of select="bezeichnung"/>
                                    <xsl:text>" in der Datenbank!]</xsl:text>
                                </xsl:otherwise>
                            </xsl:choose>
                        </xsl:otherwise>
                    </xsl:choose>
