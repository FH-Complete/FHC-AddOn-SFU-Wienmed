...
<office:document-styles xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:officeooo="http://openoffice.org/2009/office" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:drawooo="http://openoffice.org/2010/draw" xmlns:calcext="urn:org:documentfoundation:names:experimental:calc:xmlns:calcext:1.0" xmlns:loext="urn:org:documentfoundation:names:experimental:office:xmlns:loext:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2">
  ...
  <office:styles>
    <style:default-style style:family="graphic">
      ...
      <style:text-properties style:use-window-font-color="true" style:font-name="Times New Roman" fo:font-size="12pt" fo:language="de" fo:country="AT" style:font-name-asian="Droid Sans Fallback" style:font-size-asian="10.5pt" style:language-asian="zh" style:country-asian="CN" style:font-name-complex="FreeSans" style:font-size-complex="12pt" style:language-complex="hi" style:country-complex="IN"/>
    </style:default-style>
    <style:default-style style:family="paragraph">
      ...
      <style:text-properties style:use-window-font-color="tfrue" style:font-name="Times New Roman" fo:font-size="12pt" fo:language="de" fo:country="AT" style:font-name-asian="Droid Sans Fallback" style:font-size-asian="10.5pt" style:language-asian="zh" style:country-asian="CN" style:font-name-complex="FreeSans" style:font-size-complex="12pt" style:language-complex="hi" style:country-complex="IN" fo:hyphenate="false" fo:hyphenation-remain-char-count="2" fo:hyphenation-push-char-count="2"/>
    </style:default-style>
    ...
    <style:style style:name="Standard" style:family="paragraph" style:class="text">
      ...
      <style:text-properties style:use-window-font-color="true" style:font-name="Arial" fo:font-family="Arial" style:font-family-generic="swiss" style:font-pitch="variable" fo:font-size="8pt" fo:language="de" fo:country="DE" style:font-name-asian="Times New Roman" style:font-family-asian="'Times New Roman'" style:font-family-generic-asian="roman" style:font-pitch-asian="variable" style:font-size-asian="8pt" style:font-name-complex="Arial" style:font-family-complex="Arial" style:font-family-generic-complex="swiss" style:font-pitch-complex="variable" style:font-size-complex="12pt" style:language-complex="ar" style:country-complex="SA"/>
    </style:style>
    <style:style style:name="Heading" style:family="paragraph" style:parent-style-name="Standard" style:next-style-name="Text_20_body" style:class="text">
      <style:paragraph-properties fo:margin-top="0.423cm" fo:margin-bottom="0.212cm" style:contextual-spacing="false" fo:keep-with-next="always"/>
      <style:text-properties style:font-name="Arial" fo:font-family="Arial" style:font-family-generic="swiss" style:font-pitch="variable" fo:font-size="14pt" style:font-name-asian="Droid Sans Fallback" style:font-family-asian="'Droid Sans Fallback'" style:font-family-generic-asian="system" style:font-pitch-asian="variable" style:font-size-asian="14pt" style:font-name-complex="FreeSans" style:font-family-complex="FreeSans" style:font-family-generic-complex="system" style:font-pitch-complex="variable" style:font-size-complex="14pt"/>
    </style:style>
    ...
    <style:style style:name="Heading_20_1" style:display-name="Heading 1" style:family="paragraph" style:parent-style-name="Standard" style:next-style-name="Standard" style:class="text">
      ...
      <style:text-properties fo:color="#0086cb" fo:font-size="36pt" fo:language="de" fo:country="AT" style:letter-kerning="true" style:font-size-asian="36pt" style:font-name-complex="Arial" style:font-family-complex="Arial" style:font-family-generic-complex="swiss" style:font-pitch-complex="variable" style:font-size-complex="16pt" style:font-weight-complex="bold"/>
    </style:style>
    <style:style style:name="Heading_20_2" style:display-name="Heading 2" style:family="paragraph" style:parent-style-name="Standard" style:next-style-name="Standard" style:class="text">
      <style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0.212cm" style:contextual-spacing="false" fo:line-height="110%" fo:keep-with-next="always"/>
      <style:text-properties fo:color="#0086cb" fo:font-size="26pt" style:font-size-asian="26pt" style:font-name-complex="Arial" style:font-family-complex="Arial" style:font-family-generic-complex="swiss" style:font-pitch-complex="variable" style:font-size-complex="14pt" style:font-style-complex="italic" style:font-weight-complex="bold"/>
    </style:style>
    <style:style style:name="Heading_20_3" style:display-name="Heading 3" style:family="paragraph" style:parent-style-name="Standard" style:next-style-name="Standard" style:class="text">
      <style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0.212cm" style:contextual-spacing="false" fo:line-height="110%" fo:keep-with-next="always"/>
      <style:text-properties fo:color="#0086cb" fo:font-size="18pt" style:font-size-asian="18pt" style:font-name-complex="Arial" style:font-family-complex="Arial" style:font-family-generic-complex="swiss" style:font-pitch-complex="variable" style:font-size-complex="13pt" style:font-weight-complex="bold"/>
    </style:style>
    ...
    <style:style style:name="Heading_20_5" style:display-name="Heading 5" style:family="paragraph" style:parent-style-name="Standard" style:next-style-name="Standard" style:class="text">
      <style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0.106cm" style:contextual-spacing="false" fo:line-height="110%"/>
    ...
    <style:style style:name="Tabellenkopf" style:family="paragraph" style:parent-style-name="Formatvorlage_20_Fett_20_Zeilenabstand_3a__20__20_einfach">
      <style:paragraph-properties fo:margin-top="0.071cm" fo:margin-bottom="0.071cm" style:contextual-spacing="false" fo:line-height="110%"/>
    ...
    <style:style style:name="WW8Num11z0" style:family="text">
      <style:text-properties fo:color="#000000" style:text-position="0% 100%" style:font-name="Wingdings" fo:font-family="Wingdings" style:font-pitch="variable" style:font-charset="x-symbol" fo:font-size="14pt" style:font-size-asian="14pt" style:font-name-complex="Wingdings" style:font-family-complex="Wingdings" style:font-pitch-complex="variable" style:font-charset-complex="x-symbol" style:font-size-complex="14pt"/>
    </style:style>
    ...
    <style:style style:name="WW8Num12z0" style:family="text">
      <style:text-properties fo:font-variant="normal" fo:text-transform="none" fo:color="#000000" style:text-outline="false" style:text-line-through-style="none" style:text-line-through-type="none" style:text-position="-7% 100%" style:font-name="Wingdings" fo:font-family="Wingdings" style:font-pitch="variable" style:font-charset="x-symbol" fo:font-size="14pt" fo:font-style="normal" fo:text-shadow="none" fo:font-weight="normal" style:font-size-asian="14pt" style:font-style-asian="normal" style:font-weight-asian="normal" style:font-name-complex="Wingdings" style:font-family-complex="Wingdings" style:font-pitch-complex="variable" style:font-charset-complex="x-symbol" style:font-size-complex="14pt" text:display="true"/>
    </style:style>
    ...
    <style:style style:name="WW8Num15z2" style:family="text">
      <style:text-properties style:text-position="-9% 100%" style:font-name="Wingdings" fo:font-family="Wingdings" style:font-pitch="variable" style:font-charset="x-symbol" fo:font-size="11pt" style:font-size-asian="11pt" style:font-name-complex="Wingdings" style:font-family-complex="Wingdings" style:font-pitch-complex="variable" style:font-charset-complex="x-symbol"/>
    </style:style>
    ...
    <style:style style:name="WW8Num17z0" style:family="text">
      <style:text-properties fo:font-variant="normal" fo:text-transform="none" fo:color="#008462" style:text-outline="false" style:text-line-through-style="none" style:text-line-through-type="none" style:text-position="-12% 100%" style:font-name="Wingdings" fo:font-family="Wingdings" style:font-pitch="variable" style:font-charset="x-symbol" fo:font-size="16pt" fo:text-shadow="none" style:font-size-asian="16pt" style:font-name-complex="Wingdings" style:font-family-complex="Wingdings" style:font-pitch-complex="variable" style:font-charset-complex="x-symbol" style:font-size-complex="16pt" text:display="true"/>
    </style:style>
    ...
    <style:style style:name="WW8Num21z1" style:family="text">
      <style:text-properties style:text-position="9% 100%" style:font-name="Helvetica" fo:font-family="Helvetica" style:font-family-generic="swiss" style:font-pitch="variable" fo:font-size="11pt" style:font-size-asian="11pt" style:font-name-complex="Helvetica" style:font-family-complex="Helvetica" style:font-family-generic-complex="swiss" style:font-pitch-complex="variable"/>
    </style:style>
    ...
    <style:style style:name="WW8Num22z2" style:family="text">
      <style:text-properties fo:font-variant="normal" fo:text-transform="none" fo:color="#000000" style:text-outline="false" style:text-line-through-style="none" style:text-line-through-type="none" style:text-position="-9% 100%" style:font-name="Wingdings" fo:font-family="Wingdings" style:font-pitch="variable" style:font-charset="x-symbol" fo:font-size="11pt" fo:font-style="normal" fo:text-shadow="none" fo:font-weight="normal" style:font-size-asian="11pt" style:font-style-asian="normal" style:font-weight-asian="normal" style:font-name-complex="Wingdings" style:font-family-complex="Wingdings" style:font-pitch-complex="variable" style:font-charset-complex="x-symbol" style:font-size-complex="11pt" text:display="true"/>
    </style:style>
    ...
    <style:style style:name="WW8Num25z0" style:family="text">
      <style:text-properties style:text-position="-7% 100%" style:font-name="Wingdings" fo:font-family="Wingdings" style:font-pitch="variable" style:font-charset="x-symbol" fo:font-size="14pt" style:font-size-asian="14pt" style:font-name-complex="Wingdings" style:font-family-complex="Wingdings" style:font-pitch-complex="variable" style:font-charset-complex="x-symbol"/>
    </style:style>
    ...
    <style:style style:name="_20_Zchn_20_Zchn" style:display-name=" Zchn Zchn" style:family="text">
      <style:text-properties style:font-name="Arial" fo:font-family="Arial" style:font-family-generic="swiss" style:font-pitch="variable" fo:font-size="8pt" fo:language="de" fo:country="DE" style:font-size-asian="8pt" style:font-name-complex="Arial" style:font-family-complex="Arial" style:font-family-generic-complex="swiss" style:font-pitch-complex="variable" style:font-size-complex="12pt"/>
    </style:style>
    <style:style style:name="_20_Zchn_20_Zchn1" style:display-name=" Zchn Zchn1" style:family="text">
      <style:text-properties style:font-name="Arial" fo:font-family="Arial" style:font-family-generic="swiss" style:font-pitch="variable" fo:font-size="9pt" fo:language="de" fo:country="DE" style:font-size-asian="9pt" style:font-name-complex="Arial" style:font-family-complex="Arial" style:font-family-generic-complex="swiss" style:font-pitch-complex="variable" style:font-size-complex="12pt"/>
    </style:style>
  ...
  <office:automatic-styles>
    ...
    <style:page-layout style:name="Mpm3" style:page-usage="right">
      ...
      <style:header-style>
        <style:header-footer-properties fo:min-height="0.499cm" fo:margin-left="0cm" fo:margin-right="0cm" fo:margin-bottom="0cm"/>
      </style:header-style>
      <style:footer-style>
        <style:header-footer-properties fo:min-height="0.499cm" fo:margin-left="0cm" fo:margin-right="0cm" fo:margin-top="0cm"/>
      </style:footer-style>
    </style:page-layout>
  ...
  <office:master-styles>
    <style:master-page style:name="Standard" style:page-layout-name="Mpm1">
      <style:header>
        <text:p text:style-name="MP1">
          <draw:frame draw:style-name="Mfr1" draw:name="Bild2" text:anchor-type="paragraph" svg:width="4.988cm" svg:height="1.946cm" draw:z-index="6">
      ...
      <style:footer>
        ...
        <text:p text:style-name="MP3">
          <text:span text:style-name="MT1">Sigmund Freud PrivatUniversität Wien, Freudplatz 1, A-1020 Wien</text:span>
    ...
    <style:master-page style:name="Right_20_Page" style:display-name="Right Page" style:page-layout-name="Mpm3" style:next-style-name="Left_20_Page">
      <style:header>
        <text:p text:style-name="MP1">
          <draw:frame draw:style-name="Mfr2" draw:name="Bild1" text:anchor-type="char" svg:x="11.506cm" svg:y="-0.113cm" svg:width="4.988cm" svg:height="1.946cm" draw:z-index="0">
            <draw:image xlink:href="Pictures/100000000000013C0000007185208078.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
          </draw:frame>
        </text:p>
      </style:header>
      <style:footer>
        <text:p text:style-name="MP2"/>
        <text:p text:style-name="MP3">
          <text:span text:style-name="MT2">Sigmund Freud PrivatUniversität Wien, Freudplatz 1, A-1020 Wien <text:tab/><text:tab/></text:span>
        </text:p>
      </style:footer>
    </style:master-page>
    ...
    <style:master-page style:name="Convert_20_1" style:display-name="Convert 1" style:page-layout-name="Mpm6">
      <style:header>
        <text:p text:style-name="MP1">
          <draw:frame draw:style-name="Mfr1" draw:name="Bild3" text:anchor-type="paragraph" svg:width="4.988cm" svg:height="1.946cm" draw:z-index="15">
            <draw:image xlink:href="Pictures/100000000000013C0000007185208078.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
          </draw:frame>
        </text:p>
      </style:header>
      <style:footer>
        ...
        <text:p text:style-name="MP5">
          <text:span text:style-name="MT1">Sigmund Freud PrivatUniversität Wien, Freudplatz 1, A-1020 Wien <text:s text:c="15"/></text:span>
          <text:span text:style-name="MT2">
            <text:tab/>
            <text:tab/>
          </text:span>
