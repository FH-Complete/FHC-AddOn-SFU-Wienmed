			...
			<fo:flow  ><!--flow-name="xsl-region-body"-->
				...
				<fo:block-container position="absolute" top="90mm" left="15mm">
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						...
						Ausserhalb der Universität können Sie per SSH bzw. WinSCP auf Ihre Daten auch von zu Hause aus zugreifen.\n
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Eine Anleitung zur Einrichtung Ihres Mail-Clients finden Sie auf https://cis.sfu.ac.at unter dem Punkt FAQ.\n
						Eine weitere Möglichkeit, von überall Mails abzurufen, ist unser Webmail Service auf https://mail.uni.sfu.ac.at/SOGo/\n
					</fo:block>
			  ...
			  <fo:block-container position="absolute" top="80mm" left="80mm">
				...
				<fo:block-container position="absolute" top="90mm" left="15mm">
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Windows XP/7: Hold down &lt;ctrl&gt; + &lt;alt&gt; + &lt;delete&gt; simultaneously to log in to the domain of the University. Enter your user name (Account) and password in the log-in window.
					</fo:block>
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						In Windows XP and Windows 7, log in to the TW domain, and you will be automatically connected to volume M:, which contains your personal disk space.\n
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						From within the University, you can always access volume M: in Windows XP and Windows 7. From outside, use an SSH or SCP client to connect to <xsl:value-of select="fileserver" />.\n
					</fo:block>
